...
})(["margin:10px 20px;text-transform:uppercase;font-weight:bold;font-size:12px;cursor:pointer;position:relative;&:after{content:'';position:absolute;left:0;display:inline-block;height:1em;border-bottom:2px solid;margin-top:3px;transition:width .25s;width:", "}&:hover,&:focus,&:active{&:after{width:80%;}}"], function (props) {
  return props.selected ? '80%' : '0';
});
...
//# sourceMappingURL=releases.js.0d64739d1ee174845e6d.hot-update.js.map