...
})(["margin:10px 20px;text-transform:uppercase;font-weight:bold;font-size:12px;cursor:pointer;position:relative;&:after{content:'';position:absolute;left:0;display:inline-block;height:1em;width:100%;border-bottom:2px solid;margin-top:5px;transition:width .25s;width:", "}&:hover,&:focus,&:active{&:after{width:100%;}}"], function (props) {
...
//# sourceMappingURL=releases.js.4e1e6c8b5959649e8b1e.hot-update.js.map