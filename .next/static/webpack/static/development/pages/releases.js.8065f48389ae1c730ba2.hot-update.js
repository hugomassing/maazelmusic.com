...
})(["margin:10px 20px;text-transform:uppercase;font-weight:bold;font-size:12px;cursor:pointer;position:relative;&:after{content:'';position:absolute;left:0;display:inline-block;height:2px;border-bottom:2px solid;margin-top:3px;transition:width .25s;width:", "}&:hover,&:focus,&:active{&:after{width:80%;}}"], function (props) {
...
//# sourceMappingURL=releases.js.8065f48389ae1c730ba2.hot-update.js.map