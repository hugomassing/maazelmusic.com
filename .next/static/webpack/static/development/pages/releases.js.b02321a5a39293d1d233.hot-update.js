...
})(["margin:10px 20px;text-transform:uppercase;font-weight:bold;font-size:12px;cursor:pointer;position:relative;&:after{content:'';position:absolute;left:0;display:inline-block;height:2px;border-bottom:2px solid;margin-top:3px;transition:width .25s;width:", "}&:hover,&:focus,&:active{&:after{width:100%;}}"], function (props) {
...
//# sourceMappingURL=releases.js.b02321a5a39293d1d233.hot-update.js.map